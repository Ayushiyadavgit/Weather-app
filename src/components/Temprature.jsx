...
function Temprature({ setCity, stats }) {
  ...
  return (
    <>
      ...
      <div className="flex justify-center mt-8">
        {stats.isDay !== 0 ? (
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-12 h-12 text-slate-300  text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
      ...
      <div className="flex justify-center item-center text-slate-200 mt-8">
      ...
      <div className="flex justify-center item-center text-slate-300 mt-8 text-[25px] text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
        {stats.condition}
      </div>

      <div className="flex justify-center item-center text-slate-400 mt-5 text-[15px]">
